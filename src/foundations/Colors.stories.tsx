...
function Swatch({
  ...
  return (
    <div style={{ width: 140 }}>
      ...
      <div style={{ fontSize: 12, marginTop: 6, color: 'var(--color-text)' }}>{info.hex}</div>
      <div style={{ fontSize: 10, color: 'var(--color-text-secondary)' }}>{info.hsl}</div>
      <div style={{ fontSize: 10, color: 'var(--color-text-secondary)' }}>{info.oklch}</div>
