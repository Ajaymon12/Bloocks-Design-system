    ...
    <div className={cn('flex flex-col gap-[var(--space-4)] font-[family-name:var(--font-family-primary)]', className)}>
      ...
      >
        <div className="relative">
          <PopoverTrigger asChild>
            <button
              ...
              className={cn(
                ...
                canClear ? 'pr-[var(--space-48)]' : 'pr-[var(--space-32)]',
              )}
            >
          ...
          <div className="pointer-events-none absolute right-[var(--space-12)] top-1/2 flex -translate-y-1/2 items-center gap-[var(--space-4)]">
            {canClear && (
              <button
                type="button"
